 ...
 * based on David Paiva's work (david@nailbuster.com)
 *
...
private:
  ...
  String _FTP_USER;
  String _FTP_PASS;
  boolean transfer_en_cours;

  internalState cmdStatus, // state of ftp control connection
